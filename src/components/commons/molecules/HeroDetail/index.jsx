  ...
  return (
    <>
      <section className="flex max-md:flex-col-reverse">
        <div className="w-[60%] text-left text-black max-xl:w-[50%] max-md:mt-8 max-md:w-full">
          <p>Aiden R. Vale</p>

          <div className="flex gap-8 max-xl:flex-col">
            <div>
              <h3 className="mt-1 font-barlow max-w-92 text-4xl leading-7 font-bold max-xl:w-75 max-xl:text-3xl">
                Empowering Digital Experiences Through Frontend Development
              </h3>
              <p className="text-md mt-4 max-w-75 leading-4 font-light">
        ...
        <div className="flex w-[40%] flex-col gap-4 pl-4 max-xl:w-[50%] max-md:mt-14 max-md:w-full">
          <div className="mt-16 hidden gap-1 text-black max-xl:flex">
            {viewListSkills()}
          </div>
